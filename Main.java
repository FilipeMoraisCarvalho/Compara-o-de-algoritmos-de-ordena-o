...
public class Main {
    public static void main(String[] args) {
    	...
    	System.out.println("######### PRIMEIRO CENÁRIO: Dados de entrada aleatorizados     #########");
    	System.out.println(" ");
    	for(int i = 0; i < 5; i++) {
    	...
    	System.out.println("######### SEGUNDO CENÁRIO: Dados de entrada já ordenados     #########");
    	System.out.println(" ");
    	for(int i = 0; i < 5; i++) {
    		System.out.println("######### EXECUÇÃO " + (i+1) + "     #########");
    		System.out.println(" ");
    	...
    	System.out.println("######### TERCEIRO CENÁRIO : Dados de entrada já ordenados     #########");
    	System.out.println(" ");
    	for(int i = 0; i < 5; i++) {
    		System.out.println("######### EXECUÇÃO " + (i+1) + "     #########");
    		System.out.println(" ");
